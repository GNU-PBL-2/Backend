package gnu.project.pbl2.common.error;

import static gnu.project.pbl2.common.error.ErrorCode.INVALID_ENUM_FORMAT;
import static gnu.project.pbl2.common.error.ErrorCode.MESSAGE_BODY_UNREADABLE;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse<Map<String, String>>> handleMethodArgumentNotValid(
        ...
        return createErrorResponseEntity(errors);
    }
    ...
    private <T> ResponseEntity<ErrorResponse<T>> createErrorResponseEntity(T data) {
        return new ResponseEntity<>(
            ErrorResponse.of(ErrorCode.BAD_REQUEST, data),
