...
public class AdminRecipeController implements AdminRecipeControllerDocs {
    ...
    @PostMapping
    @Override
    public ResponseEntity<Void> createRecipe(@RequestBody @Valid final AdminRecipeCreateRequest request,
        @Auth final Accessor accessor) {
    ...
    @PutMapping("/{id}")
    @Override
    public ResponseEntity<Long> updateRecipe(@PathVariable(name = "id") final Long id,
    ...
    @DeleteMapping("/{id}")
    @Override
    public ResponseEntity<Long> deleteRecipe(@PathVariable(name = "id") final Long id,
        @Auth final Accessor accessor) {
